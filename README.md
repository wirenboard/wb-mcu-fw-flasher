...
holding-регистр `0x81` (`129`) -- записать ненулевое значение - загрузчик будет работать с параметрами 9600N2.
holding-регистр `0x83` (`131`) -- записать ненулевое значение - загрузчик будет работать с текущими настройками соединения. Нужна поддержка со стороны прошивки и загрузчик версии 1.3.0 и выше. Подробнее - в changelog прошивки.
