...
Обновление bootloader происходит так же, как и обновление прошивки - загрузкой файла `.wbfw` в устройство.

**ВНИМАНИЕ:** обновление bootloader — потенциально опасная операция. Если во время обновления загрузчика пропало питание, устройство может превратиться в «кирпич». В этом случае гарантия на него аннулируется. Чтобы избежать такой ситуации — резервируйте питание контроллера и устройства, например, с помощью WB-UPS v.2.
