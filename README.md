...
| 1003    | 1     | holding | read           | Максмальное количество блоков данных новой прошивки, которое не приведёт к потере настроек, хранящихся во FlashFS, при обновлении прошивки  | С версии 1.2.0 |
